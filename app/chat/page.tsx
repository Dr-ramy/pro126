  ...
  return (
    <div className="max-w-2xl mx-auto p-4 h-screen flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold">Chating Room</h1>
        <Link href="/content" className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded">
          <FaArrowLeft />
          <span>Home</span>
        </Link>
      </div>
      ...
      <div className="flex-1 overflow-y-auto border rounded p-4 mb-4 bg-white shadow">
        {messages.length === 0 && <p className="text-center text-gray-500">No message</p>}
      ...
      {isValidating && <p className="text-center text-gray-500 mt-2">Loading...</p>}
